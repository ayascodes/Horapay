...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customuser',
            name='mois',
            field=models.CharField(choices=[('Janvier', 'Janvier'), ('Février', 'Février'), ('Mars', 'Mars'), ('Avril', 'Avril'), ('Mai', 'Mai'), ('Juin', 'Juin'), ('Juillet', 'Juillet'), ('Août', 'Août'), ('Septembre', 'Septembre'), ('Octobre', 'Octobre'), ('Novembre', 'Novembre'), ('Décembre', 'Décembre')], default=1, max_length=10),
        ),
        migrations.AddField(
            model_name='customuser',
            name='nom',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pour', models.CharField(choices=[('Que pour une semaine', 'Que pour une semaine'), ('Pour le semestre', 'Pour le semestre')], default='Que pour une semaine', max_length=20)),
                ('date', models.DateField(null=True)),
                ('jour', models.CharField(choices=[('1', 'Samedi'), ('2', 'Dimanche'), ('3', 'Lundi'), ('4', 'Mardi'), ('5', 'Mercredi'), ('6', 'Jeudi')], default='Dimanche', max_length=10, null=True)),
                ('heure_debut', models.IntegerField()),
                ('heure_fin', models.IntegerField()),
                ('type_session', models.CharField(choices=[('1', 'Cours'), ('2', 'TD'), ('3', 'TP')], default='Cours', max_length=10)),
                ('enseignant', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
