    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jour', models.CharField(blank=True, choices=[('Samedi', 'Samedi'), ('Dimanche', 'Dimanche'), ('Lundi', 'Lundi'), ('Mardi', 'Mardi'), ('Mercredi', 'Mercredi'), ('Jeudi', 'Jeudi')], default='Dimanche', max_length=10, null=True)),
                ('heure_supp', models.BooleanField(default=False)),
                ('heure_debut', models.IntegerField()),
                ('heure_fin', models.IntegerField()),
                ('type_session', models.CharField(choices=[('Cours', 'Cours'), ('TD', 'TD'), ('TP', 'TP')], default='Cours', max_length=10)),
                ('Departement', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='testing.departement')),
