...
urlpatterns = [  
    ...
    path('semestres/current/', SemestreCurrentYearList.as_view(), name='semestre-current-year-list'),
    ...
    path('InfoHeureSup/', InfoHeureSupList.as_view()),
    path('InfoHeureSup/<int:pk>', InfoHeureSupDetail.as_view()),
